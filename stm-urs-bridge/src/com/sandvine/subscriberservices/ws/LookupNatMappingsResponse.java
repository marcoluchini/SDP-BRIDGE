/**
 * LookupNatMappingsResponse.java
 *
...
public class LookupNatMappingsResponse  extends com.sandvine.subscriberservices.ws.BulkOperationResponse  implements java.io.Serializable {
    private com.sandvine.subscriberservices.ws.NatMapping[] natMappings;

    private com.sandvine.subscriberservices.ws.LookupNatMappingsPartialFailure[] partialFailures;

    public LookupNatMappingsResponse() {
    }
    ...
    public LookupNatMappingsResponse(
           ...
           com.sandvine.subscriberservices.ws.LookupNatMappingsPartialFailure[] partialFailures) {
        super(
            result,
            errors,
    ...
    /**
     * Gets the natMappings value for this LookupNatMappingsResponse.
     * 
     * @return natMappings
     */
    ...
    /**
     * Sets the natMappings value for this LookupNatMappingsResponse.
     * 
     * @param natMappings
     */
    ...
    /**
     * Gets the partialFailures value for this LookupNatMappingsResponse.
     * 
     * @return partialFailures
     */
    public com.sandvine.subscriberservices.ws.LookupNatMappingsPartialFailure[] getPartialFailures() {
        return partialFailures;
    }


    /**
     * Sets the partialFailures value for this LookupNatMappingsResponse.
     * 
     * @param partialFailures
     */
    public void setPartialFailures(com.sandvine.subscriberservices.ws.LookupNatMappingsPartialFailure[] partialFailures) {
        this.partialFailures = partialFailures;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LookupNatMappingsResponse)) return false;
        LookupNatMappingsResponse other = (LookupNatMappingsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LookupNatMappingsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "LookupNatMappingsResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "LookupNatMappingsPartialFailure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
