/**
 * CreateNatMappingsResponse.java
 *
...
public class CreateNatMappingsResponse  extends com.sandvine.subscriberservices.ws.BulkOperationResponse  implements java.io.Serializable {
    private com.sandvine.subscriberservices.ws.NatMapping[] natMappings;

    private com.sandvine.subscriberservices.ws.CreateNatMappingsPartialFailure[] partialFailures;

    public CreateNatMappingsResponse() {
    }
    ...
    public CreateNatMappingsResponse(
           ...
           com.sandvine.subscriberservices.ws.CreateNatMappingsPartialFailure[] partialFailures) {
        super(
            result,
            errors,
    ...
    /**
     * Gets the natMappings value for this CreateNatMappingsResponse.
     * 
     * @return natMappings
     */
    ...
    /**
     * Sets the natMappings value for this CreateNatMappingsResponse.
     * 
     * @param natMappings
     */
    ...
    /**
     * Gets the partialFailures value for this CreateNatMappingsResponse.
     * 
     * @return partialFailures
     */
    public com.sandvine.subscriberservices.ws.CreateNatMappingsPartialFailure[] getPartialFailures() {
        return partialFailures;
    }


    /**
     * Sets the partialFailures value for this CreateNatMappingsResponse.
     * 
     * @param partialFailures
     */
    public void setPartialFailures(com.sandvine.subscriberservices.ws.CreateNatMappingsPartialFailure[] partialFailures) {
        this.partialFailures = partialFailures;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateNatMappingsResponse)) return false;
        CreateNatMappingsResponse other = (CreateNatMappingsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateNatMappingsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "CreateNatMappingsResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "CreateNatMappingsPartialFailure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
