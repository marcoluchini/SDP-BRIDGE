/**
 * SetSessionAttributesResponse.java
 *
...
public class SetSessionAttributesResponse  extends com.sandvine.subscriberservices.ws.BulkOperationResponse  implements java.io.Serializable {
    private com.sandvine.subscriberservices.ws.IpAssignment[] ipAssignments;

    private com.sandvine.subscriberservices.ws.SetSessionAttributesPartialFailure[] partialFailures;

    public SetSessionAttributesResponse() {
    }
    ...
    public SetSessionAttributesResponse(
           ...
           com.sandvine.subscriberservices.ws.SetSessionAttributesPartialFailure[] partialFailures) {
        super(
            result,
            errors,
    ...
    /**
     * Gets the ipAssignments value for this SetSessionAttributesResponse.
     * 
    ...
    /**
     * Sets the ipAssignments value for this SetSessionAttributesResponse.
     * 
     * @param ipAssignments
     */
    ...
    /**
     * Gets the partialFailures value for this SetSessionAttributesResponse.
     * 
     * @return partialFailures
     */
    public com.sandvine.subscriberservices.ws.SetSessionAttributesPartialFailure[] getPartialFailures() {
        return partialFailures;
    }


    /**
     * Sets the partialFailures value for this SetSessionAttributesResponse.
     * 
     * @param partialFailures
     */
    public void setPartialFailures(com.sandvine.subscriberservices.ws.SetSessionAttributesPartialFailure[] partialFailures) {
        this.partialFailures = partialFailures;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SetSessionAttributesResponse)) return false;
        SetSessionAttributesResponse other = (SetSessionAttributesResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SetSessionAttributesResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "SetSessionAttributesResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "SetSessionAttributesPartialFailure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
