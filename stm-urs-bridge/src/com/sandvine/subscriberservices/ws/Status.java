...
public class Status implements java.io.Serializable {
    ...
    public static final Status Inactive = new Status(_Inactive);
    public static final Status Obsolete = new Status(_Obsolete);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "Status"));
    }
    /**
