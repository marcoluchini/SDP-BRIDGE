/**
 * LookupIpAssignmentsResponse.java
 *
...
public class LookupIpAssignmentsResponse  extends com.sandvine.subscriberservices.ws.BulkOperationResponse  implements java.io.Serializable {
    private com.sandvine.subscriberservices.ws.IpAssignment[] ipAssignments;

    private com.sandvine.subscriberservices.ws.LookupIpAssignmentsPartialFailure[] partialFailures;

    public LookupIpAssignmentsResponse() {
    }
    ...
    public LookupIpAssignmentsResponse(
           ...
           com.sandvine.subscriberservices.ws.LookupIpAssignmentsPartialFailure[] partialFailures) {
        super(
            result,
            errors,
    ...
    /**
     * Gets the ipAssignments value for this LookupIpAssignmentsResponse.
     * 
    ...
    /**
     * Sets the ipAssignments value for this LookupIpAssignmentsResponse.
     * 
     * @param ipAssignments
     */
    ...
    /**
     * Gets the partialFailures value for this LookupIpAssignmentsResponse.
     * 
     * @return partialFailures
     */
    public com.sandvine.subscriberservices.ws.LookupIpAssignmentsPartialFailure[] getPartialFailures() {
        return partialFailures;
    }


    /**
     * Sets the partialFailures value for this LookupIpAssignmentsResponse.
     * 
     * @param partialFailures
     */
    public void setPartialFailures(com.sandvine.subscriberservices.ws.LookupIpAssignmentsPartialFailure[] partialFailures) {
        this.partialFailures = partialFailures;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LookupIpAssignmentsResponse)) return false;
        LookupIpAssignmentsResponse other = (LookupIpAssignmentsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LookupIpAssignmentsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "LookupIpAssignmentsResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "LookupIpAssignmentsPartialFailure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
