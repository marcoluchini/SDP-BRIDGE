/**
 * LookupSubscribersResponse.java
 *
...
public class LookupSubscribersResponse  extends com.sandvine.subscriberservices.ws.BulkOperationResponse  implements java.io.Serializable {
    private com.sandvine.subscriberservices.ws.Subscriber[] subscribers;

    private com.sandvine.subscriberservices.ws.LookupSubscribersPartialFailure[] partialFailures;

    public LookupSubscribersResponse() {
    }
    ...
    public LookupSubscribersResponse(
           ...
           com.sandvine.subscriberservices.ws.LookupSubscribersPartialFailure[] partialFailures) {
        super(
            result,
            errors,
    ...
    /**
     * Gets the subscribers value for this LookupSubscribersResponse.
     * 
     * @return subscribers
     */
    ...
    /**
     * Sets the subscribers value for this LookupSubscribersResponse.
     * 
     * @param subscribers
     */
    ...
    /**
     * Gets the partialFailures value for this LookupSubscribersResponse.
     * 
     * @return partialFailures
     */
    public com.sandvine.subscriberservices.ws.LookupSubscribersPartialFailure[] getPartialFailures() {
        return partialFailures;
    }


    /**
     * Sets the partialFailures value for this LookupSubscribersResponse.
     * 
     * @param partialFailures
     */
    public void setPartialFailures(com.sandvine.subscriberservices.ws.LookupSubscribersPartialFailure[] partialFailures) {
        this.partialFailures = partialFailures;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LookupSubscribersResponse)) return false;
        LookupSubscribersResponse other = (LookupSubscribersResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LookupSubscribersResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "LookupSubscribersResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "LookupSubscribersPartialFailure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
