/**
 * SetSubscriberAttributesResponse.java
 *
...
public class SetSubscriberAttributesResponse  extends com.sandvine.subscriberservices.ws.BulkOperationResponse  implements java.io.Serializable {
    private com.sandvine.subscriberservices.ws.Subscriber[] subscribers;

    private com.sandvine.subscriberservices.ws.SetSubscriberAttributesPartialFailure[] partialFailures;

    public SetSubscriberAttributesResponse() {
    }
    ...
    public SetSubscriberAttributesResponse(
           ...
           com.sandvine.subscriberservices.ws.SetSubscriberAttributesPartialFailure[] partialFailures) {
        super(
            result,
            errors,
    ...
    /**
     * Gets the subscribers value for this SetSubscriberAttributesResponse.
     * 
     * @return subscribers
     */
    ...
    /**
     * Sets the subscribers value for this SetSubscriberAttributesResponse.
     * 
     * @param subscribers
     */
    ...
    /**
     * Gets the partialFailures value for this SetSubscriberAttributesResponse.
     * 
     * @return partialFailures
     */
    public com.sandvine.subscriberservices.ws.SetSubscriberAttributesPartialFailure[] getPartialFailures() {
        return partialFailures;
    }


    /**
     * Sets the partialFailures value for this SetSubscriberAttributesResponse.
     * 
     * @param partialFailures
     */
    public void setPartialFailures(com.sandvine.subscriberservices.ws.SetSubscriberAttributesPartialFailure[] partialFailures) {
        this.partialFailures = partialFailures;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SetSubscriberAttributesResponse)) return false;
        SetSubscriberAttributesResponse other = (SetSubscriberAttributesResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SetSubscriberAttributesResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "SetSubscriberAttributesResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "SetSubscriberAttributesPartialFailure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
