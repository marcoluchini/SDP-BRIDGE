...
public class Result implements java.io.Serializable {
    ...
    public static final Result Partial = new Result(_Partial);
    public static final Result Asynchronous = new Result(_Asynchronous);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "Result"));
    }
    /**
