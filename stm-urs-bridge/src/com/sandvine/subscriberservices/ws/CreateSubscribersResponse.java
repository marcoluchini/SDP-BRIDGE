/**
 * CreateSubscribersResponse.java
 *
...
public class CreateSubscribersResponse  extends com.sandvine.subscriberservices.ws.BulkOperationResponse  implements java.io.Serializable {
    private com.sandvine.subscriberservices.ws.Subscriber[] subscribers;

    private com.sandvine.subscriberservices.ws.SubscriberPartialFailure[] partialFailures;

    public CreateSubscribersResponse() {
    }
    ...
    public CreateSubscribersResponse(
           ...
           com.sandvine.subscriberservices.ws.SubscriberPartialFailure[] partialFailures) {
        super(
            result,
            errors,
    ...
    /**
     * Gets the subscribers value for this CreateSubscribersResponse.
     * 
     * @return subscribers
     */
    ...
    /**
     * Sets the subscribers value for this CreateSubscribersResponse.
     * 
     * @param subscribers
     */
    ...
    /**
     * Gets the partialFailures value for this CreateSubscribersResponse.
     * 
     * @return partialFailures
     */
    public com.sandvine.subscriberservices.ws.SubscriberPartialFailure[] getPartialFailures() {
        return partialFailures;
    }


    /**
     * Sets the partialFailures value for this CreateSubscribersResponse.
     * 
     * @param partialFailures
     */
    public void setPartialFailures(com.sandvine.subscriberservices.ws.SubscriberPartialFailure[] partialFailures) {
        this.partialFailures = partialFailures;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateSubscribersResponse)) return false;
        CreateSubscribersResponse other = (CreateSubscribersResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateSubscribersResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "CreateSubscribersResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.subscriberservices.sandvine.com", "SubscriberPartialFailure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
